...
from .wan_teletron_video_vae import (
    AttentionBlock,
    CausalConv3d,
    ResidualBlock,
    RMS_norm,
...
class WanTeletronVideoVAE_2_2(nn.Module):
    ...
    def tiled_encode(self, video, device, tile_size, tile_stride):
        ...
        for h, h_, w, w_ in tasks:
            ...
            mask = self.build_mask(hidden_states_batch, is_bound=(h == 0, h_ >= H, w == 0, w_ >= W), border_width=((size_h - stride_h) // self.upsampling_factor, (size_w - stride_w) // self.upsampling_factor)).to(dtype=video.dtype, device=device)
